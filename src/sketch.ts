  ...
  assets = {
    images: {
      ...
      backgroundImages: [
        ...
        loadImage("../assets/background/Map-1.png"),
      ...
      maptextures: [
        loadImage("../assets/maptextures/green-6.png"),
        ...
        loadImage("../assets/maptextures/grass-figma-6.png"),
        loadImage("../assets/maptextures/tree-on-map.png"),
        loadImage("../assets/maptextures/tree-4.png"),
        loadImage("../assets/maptextures/test-1.png"),
      ],
      entities: [
