...
let assets: {
	music: {
		backgroundMusicMenu: p5.SoundFile;
		backgroundMusicInGame: p5.SoundFile;
	};
	images: {
...
function preload() {
	...
	assets = {
		music: {
			backgroundMusicMenu: loadSound("../assests/music/spelprojekt-menu.mp3"),
			backgroundMusicInGame: 
				loadSound("../assests/music/spelprojekt-ingame-v6.mp3"),
		},
		images: {
			backgroundImages: [
...
function backgroundMusicMenu(){
  assets.music.backgroundMusicMenu.play();
  assets.music.backgroundMusicMenu.loop();
  assets.music.backgroundMusicMenu.setVolume(0, 3);
  userStartAudio();
}
